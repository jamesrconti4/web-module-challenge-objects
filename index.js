...
console.log(createMenuItem('grilled cheese', 4, 'lunch'))
console.log(createMenuItem('cheese sticks', 3, 'lunch'))
...
*/
/*reviews.push{name:'jimmy', rating: 4.2, feedback: 'pretty good' }
console.log(reviews)*/
